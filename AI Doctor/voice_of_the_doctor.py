...
input_text="Hi this is Pratik Patel, autoplay testing!"
#text_to_speech_with_gtts(input_text=input_text, output_filepath="gtts_testing_autoplay.mp3")


def text_to_speech_with_elevenlabs(input_text, output_filepath):
    """
    Generate speech using ElevenLabs API with error handling
    ...
    try:
        ...
        print(f"⚠️ ElevenLabs failed ({str(e)}), falling back to gTTS")
        # Fall back to gTTS
        return text_to_speech_with_gtts(input_text, output_filepath)
    ...
    try:
        ...
        print(f"Audio generated but couldn't play: {e}")
